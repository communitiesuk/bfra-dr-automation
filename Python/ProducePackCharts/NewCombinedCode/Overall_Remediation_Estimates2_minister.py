"""
Created on Thursday February 05 2026, 15:42:43

author: Matthew Bandura
This files uses internal estimates of number of buildings remaining and is therefore not suitable for publication
"""
...
def create_Overall_remediation_estimates2_internal(type, figure_count, colours, grey, secondary_grey, paths_variables, data_label_font_dict_white, data_label_font_dict_black):
    ###########
    ...
    yet_to_identify_lower = 6100 - total_buildings - eligibility_pending
    yet_to_identify_lower = round(yet_to_identify_lower, -2) #round to the nearest 100
    yet_to_identify_upper = 9200 - total_buildings - yet_to_identify_lower - eligibility_pending
    ...
    if type==0:
        output_filename = f"InternalFigure{figure_count}.svg"
