...
def create_RAP_estimates_residents(type, figure_count, colours, grey, secondary_grey, paths_variables, data_label_font_dict_white, data_label_font_dict_black):
    ###########
    ...
    if type==0:
        output_filename = f"Figure{figure_count}_residents.svg"
