...
def BSF_headline_writer(BSF_headline_dict, dates_variables, DR):
    ...
    paragraph.add_run(f' Overall, {BSF_started_c_no} high-rise buildings ({BSF_started_c_pct}) in the BSF have either started or completed remediation works on non-ACM cladding, {BSF_started_c_line} since the end of {last_month}.')
