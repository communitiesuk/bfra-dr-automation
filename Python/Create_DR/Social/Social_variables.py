...
def Social_variable_creator(Social_handled_data_this_month, Social_handled_data_last_month):
    ...
    Social_remediation_table = pd.DataFrame({
        'Remediation Stage': ['Remediation completed', 'Works started', 'Works not started', 'Remediation progress currently unknown', 'Formatted Total Percentage'],
    ...
    Social_headline_dict = {
        'Social_self_funded_total': format(Social_1a_this_month.loc[5, 'Total Number'], ','),
        'Social_self_funded_total_change': Change_line_in_DR(Social_1a_this_month.loc[5, 'Total Number'] - Social_1a_last_month.loc[5, 'Total Number']),
    ...
    Social_section_dict = {
        'Social_total_no': format(Social_1a_this_month.loc[5, 'Total Number'], ','),
        'Social_total_change': Change_line_in_DR(Social_1a_this_month.loc[5, 'Total Number'] - Social_1a_last_month.loc[5, 'Total Number']),
        ...
        'Social_unknown_no' : format(Social_1a_this_month.loc[4, 'Total Number'], ','),
        'Social_unknown_pct' : Social_1a_this_month.loc[4, 'Formatted Total Percentage'],

        'Social_SF_18m_starts_pct' : Social_1b_this_month.loc[2, 'Cumulative 18m Percentage'],
        'Social_SF_11m_starts_pct' : Social_1b_this_month.loc[2, 'Cumulative 11_18m Percentage'],
    }
