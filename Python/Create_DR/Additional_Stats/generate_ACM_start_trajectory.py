...
def generate_ACM_start_trajectory(Master_analytical):
    ...
    ACM_start_trajectory.rename(columns={ACM_start_trajectory.columns[-4]: 'Enforcement previous', ACM_start_trajectory.columns[-3]: 'JIT previous', ACM_start_trajectory.columns[-2]: 'Enforcement',ACM_start_trajectory.columns[-1]: 'JIT'}, inplace=True)
