...
def generate_BSF_reg_status(BSF_cut, last_month_BSF_cut):
    ...
    #turns the data into a pandas data fram with rows starting at 1 columns 0
    ...
    BSF_reg_status_df_combined = BSF_reg_status_df.join(last_month_BSF_reg_status_df)
